angular.module('sqrxxDyqzyCtrl', []).controller('sqrxxDyqzyCtrl', ["$scope", "ionicToast", "$state", "$ionicHistory", "$wysqService", "$ionicPopup", "$ionicLoading", "$dictUtilsService", "$menuService", "$ionicActionSheet",
