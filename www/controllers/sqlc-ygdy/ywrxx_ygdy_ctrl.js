angular.module('ywrxxYgdyCtrl', []).controller('ywrxxYgdyCtrl', ["$scope", "ionicToast", "$stateParams", "$state", "$ionicHistory", "$wysqService", "$dictUtilsService", "$rootScope", "$menuService",
	function($scope, ionicToast, $stateParams, $state, $ionicHistory, $wysqService, $dictUtilsService, $rootScope, $menuService) {
		...
		$scope.addYwr = function() {
			if($scope.category == '7'||$scope.category == '8') {
				...
				$scope.ywr.ywh = $wysqService.djsqItemData.ywh[1];
			} 
