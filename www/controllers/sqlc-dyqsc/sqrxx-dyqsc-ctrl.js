angular.module('sqrxxDyqscCtrl', []).controller('sqrxxDyqscCtrl', ["$scope", "ionicToast", "$state", "$ionicHistory", "$wysqService", "$ionicPopup", "$ionicLoading", "$dictUtilsService", "$menuService", "$ionicActionSheet",
