//预售商品房买卖预告登记 不动产信息页面控制器
angular.module('bdcxxMmygCtrl', []).controller('bdcxxMmygCtrl', ["$scope", "ionicToast", "$stateParams", "$state", "$filter", "$ionicHistory", "$ionicActionSheet", "$wysqService", "$dictUtilsService", "$menuService", "$cordovaBarcodeScanner","$rootScope",
