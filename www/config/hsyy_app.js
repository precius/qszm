angular.module('hsyy_app', ['ionic', 'ngCordova', 'starter.controllers', 'starter.services', 'starter.utils', 'validation.rule', 'pdf'])
	...
	.config(function($stateProvider, $urlRouterProvider) {
		$stateProvider
			...
			.state('mine-person-info', {
				...
				cache: false,
				templateUrl: 'views/mine-person-info.html',
				controller: 'personalInfoCtrl'
			})
			//修改密码
			.state('mine-password-modify', {
				url: '/mine/password-modify',
				templateUrl: 'views/mine-password-modify.html',
				controller: 'passwordModifyCtrl'
			})
			//修改手机号
			.state('mine-tel-modify', {
				url: '/mine/tel-modify',
				templateUrl: 'views/mine-tel-modify.html',
			...
			.state('slide-splash', {
				...
				controller: 'hsyyLoginCtrl'
			});
		//		$urlRouterProvider.otherwise('/tab/home')
		$urlRouterProvider.otherwise('hsyy-login')
	})